...
namespace Logs
{
    ...
    public interface ILogsContext:IDbContext
    {
        ...
        IDbSet<IdentityRepositoryTestsConsoleLogsModel> IdentityRepositoryTestsConsoleLogs { get; set; }
    }
    public class LogsContext : DbContext, ILogsContext
    {
        ...
        public virtual IDbSet<IdentityRepositoryTestsConsoleLogsModel> IdentityRepositoryTestsConsoleLogs { get; set; }
    }
}
